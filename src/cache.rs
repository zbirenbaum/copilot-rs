...
use crate::copilot::{DocParams, CopilotCompletionResponse};
...
impl CopilotCache {
  ...
  pub fn set_cached_result(&self, uri: &String, lnum: &u32, completion_response: &CopilotCompletionResponse) -> Option<CopilotCompletionResponse> {
